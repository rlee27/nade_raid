...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__monster__ = __webpack_require__(7);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__monster__ = __webpack_require__(7);
...
class Game {
  ...
  checkBlastCollisions(otherObj) {
    ...
    allBlasts.forEach((blast) => {
      if (otherObj instanceof __WEBPACK_IMPORTED_MODULE_0__player__["a" /* default */]) {
...
class Player extends __WEBPACK_IMPORTED_MODULE_0__sprite__["a" /* default */] {
  ...
  isCollidedWith(otherObj) {
    if (otherObj instanceof __WEBPACK_IMPORTED_MODULE_2__blast__["a" /* default */]) {
      // debugger
      if (this.dx + 5 < otherObj.dx + otherObj.dWidth &&
        this.dx + 5 + this.dWidth - 5 > otherObj.dx &&
        this.dy + 5 < otherObj.dy + otherObj.dHeight &&
        this.dy + 5 + this.dHeight - 5 > otherObj.dy) {
          return true;
        } else {
          return false;
        }
...
class Monster extends __WEBPACK_IMPORTED_MODULE_0__sprite__["a" /* default */] {
  ...
  collideWith(otherObj) {
    ...
    } else if (otherObj instanceof __WEBPACK_IMPORTED_MODULE_2__blocks__["a" /* default */]) {
      this.wallCollision(otherObj);
    }
  }
